  ...
  return (
    <main className="min-h-screen bg-background text-on-surface">
      ...
      <div className="pt-40 lg:pt-56 pb-32 px-6 lg:px-16 max-w-[1920px] mx-auto">
        <header className="mb-24 space-y-8 reveal-on-scroll">
          ...
          <h1 className="text-6xl md:text-8xl font-headline font-black italic tracking-tighter leading-tight">
            {t('titlePrefix')} {cuisineName} <br /> <span className="text-zinc-300">{t('collection')}</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
          {restaurants.map((restaurant, i) => (
            <div key={restaurant.id} className={`reveal-on-scroll stagger-${(i % 3) + 1}`}>
