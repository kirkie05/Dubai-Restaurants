...
export default async function RestaurantMenu({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <main className="pt-32 min-h-screen">
        <div className="max-w-4xl mx-auto px-8 py-20 space-y-24">
           ...
           <footer className="pt-20 border-t border-slate-100 text-center">
              <Link href={`/restaurant/${slug}`} className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Back to Experience</Link>
           </footer>
        </div>
      </main>
