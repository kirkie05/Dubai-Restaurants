...
export default function RestaurantGallery({ params }: { params: { slug: string } }) {
  return (
      ...
      <main className="pt-32 min-h-screen">
        <div className="max-w-[1920px] mx-auto px-8 lg:px-16 py-20 space-y-20">
           <header className="flex flex-col md:flex-row justify-between items-end gap-8 pb-12 border-b border-white/10">
              ...
              <Link href={`/restaurant/${params.slug}`} className="text-primary font-body text-[10px] font-black uppercase tracking-[0.3em] pb-1 border-b border-primary/20 hover:border-primary transition-all">Close Gallery</Link>
           </header>
