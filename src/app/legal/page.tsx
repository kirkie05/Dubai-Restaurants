          ...
          <div className="flex flex-col lg:flex-row items-end justify-between gap-16 pb-16 border-b border-slate-100">
             <div className="space-y-6 max-w-4xl">
                ...
                <p className="text-xl text-slate-500 font-body italic leading-relaxed max-w-xl">
                   The legal framework that ensures the integrity and exclusivity of the Dubai Restaurant Directory experience.
                </p>
             </div>
        ...
        <section className="max-w-5xl mx-auto px-8 space-y-24">
           <div className="space-y-12">
              ...
              <div className="space-y-8 text-xl text-slate-700 font-body italic leading-relaxed">
                 <p>By accessing the Dubai Restaurant Directory (DRD), you enter a curated narrative. Our data is verified at the point of publication, but the atmospheric nature of high-fidelity dining means changes are constant. We curate, but the masters command the experience.</p>
