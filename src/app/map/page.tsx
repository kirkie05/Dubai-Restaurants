...
const LOCATIONS = [
  { id: 1, name: "Al Safa Club", type: "Japanese", rating: 4.8, x: "20%", y: "35%" },
  { id: 2, name: "Desert Fig Atelier", type: "European", rating: 4.7, x: "45%", y: "20%" },
  { id: 3, name: "Marina Ember House", type: "Grill", rating: 4.6, x: "65%", y: "55%" },
  { id: 4, name: "Nexus Point", type: "Fusion", rating: 4.9, x: "15%", y: "70%" },
  { id: 5, name: "Skyline Terrace", type: "Mediterranean", rating: 4.5, x: "80%", y: "40%" },
];
    ...
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <main className="flex-grow pt-24 relative flex flex-col lg:flex-row">
        ...
        <section className="flex-grow relative bg-slate-100 overflow-hidden">
          {/* Mock Map Background - High Fidelity Grid */}
          <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]"></div>
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 via-white to-orange-50"></div>
          ...
          {LOCATIONS.map((pin) => (
             ...
             >
                <div className="relative">
                   <div className="w-12 h-12 bg-zinc-900 rounded-full flex items-center justify-center border-4 border-white shadow-xl group-hover:bg-primary group-hover:scale-125 transition-all duration-500">
                      <span className="material-symbols-outlined text-white text-sm">restaurant</span>
                   </div>
                   {/* Hover Tooltip */}
                   <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-48 bg-white p-4 rounded-xl shadow-2xl border border-slate-50 opacity-0 group-hover:opacity-100 transition-all pointer-events-none translate-y-4 group-hover:translate-y-0">
                      <p className="font-headline font-black text-sm italic mb-1">{pin.name}</p>
