  ...
  return (
    <section id="chefs" className="py-24 lg:py-40 px-6 lg:px-16 bg-white relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-[1920px] mx-auto relative z-10">
        <header className="relative flex flex-col xl:flex-row justify-between items-start xl:items-end gap-16 mb-32 pb-16 border-b border-slate-100 reveal-on-scroll">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-24">
           {TOP_CHEFS.map((chef, i) => (
             <div key={chef.slug} className={`relative reveal-on-scroll ${i === 0 ? 'stagger-1' : i === 1 ? 'stagger-2' : i === 2 ? 'stagger-3' : ''}`}>
                <ChefCard {...chef} />
