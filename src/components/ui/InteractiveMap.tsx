      ...
      <div className="w-full h-full bg-zinc-900 flex flex-col items-center justify-center relative overflow-hidden group">
        ...
        <div className="relative z-10 p-12 text-center space-y-8 max-w-xl">
          ...
          <div className="space-y-4">
             <h3 className="text-white font-headline text-3xl md:text-5xl font-black italic tracking-tighter leading-tight">Interactive Discovery <br /><span className="text-primary">Coming Soon.</span></h3>
             <p className="text-zinc-400 font-body text-base md:text-xl italic leading-relaxed">
               We're finalizing our high-fidelity spatial engine. Please use our verified directory listings in the meantime.
             </p>
          </div>
          <div className="pt-6">
             <Link href="/restaurants" className="inline-block bg-white text-zinc-900 px-10 py-5 rounded-2xl font-headline font-black text-xl italic hover:bg-primary hover:text-white transition-all shadow-2xl">
                Browse Repository
             </Link>
          </div>
        </div>
